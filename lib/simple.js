  ...
  enumerable: true
    ...
    getName: {
      ...
      value(jid = '', withoutContact = false) {
        ...
        return (withoutContact ? '' : v.name) || v.subject || v.vname || v.notify || v.verifiedName || (v.username ? '@' + v.username : '') || (v.lidUsername ? '@' + v.lidUsername : '') || PhoneNumber('+' + jid.replace('@s.whatsapp.net', '')).getNumber('international');
      },
      enumerable: true,
    },
    loadMessage: {
      ...
      get() {
        ...
        name: {
            get() {
                ...
                if (pn && typeof pn === 'string' && pn.trim()) return pn
...
function nullish(args) {
  if (typeof args === 'string' && args.trim() === '') return true
