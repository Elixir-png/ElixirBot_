...
let handler = async (m, { conn, participants, isBotAdmin }) => {
    ...
    await conn.sendMessage(m.chat, {
        text: `𝐈𝐥 𝐝𝐢𝐬𝐥𝐨𝐜𝐚𝐦𝐞𝐧𝐭𝐨 𝐞̀ 𝐜𝐨𝐦𝐩𝐢𝐮𝐭𝐨. 𝐄𝐩𝐩𝐮𝐫𝐞, 𝐧𝐞𝐥 𝐬𝐢𝐥𝐞𝐧𝐳𝐢𝐨 𝐝𝐞𝐥𝐥𝐚 𝐝𝐢𝐬𝐩𝐞𝐫𝐬𝐢𝐨𝐧𝐞, 𝐥𝐚 𝐩𝐫𝐨𝐦𝐞𝐬𝐬𝐚 𝐝𝐢𝐯𝐢𝐧𝐚 𝐧𝐨𝐧 𝐬𝐢 𝐬𝐩𝐞𝐠𝐧𝐞, 𝐦𝐚 𝐬𝐮𝐬𝐬𝐮𝐫𝐫𝐚 𝐚𝐥 𝐯𝐢𝐚𝐧𝐝𝐚𝐧𝐭𝐞 𝐥𝐚 𝐯𝐢𝐚 𝐝𝐞𝐥 𝐫𝐢𝐭𝐨𝐫𝐧𝐨. 𝐂𝐨𝐥𝐮𝐢 𝐜𝐡𝐞 𝐡𝐚 𝐩𝐞𝐫𝐦𝐞𝐬𝐬𝐨 𝐥𝐨 𝐬𝐫𝐚𝐝𝐢𝐜𝐚𝐦𝐞𝐧𝐭𝐨 𝐩𝐫𝐞𝐩𝐚𝐫𝐚 𝐮𝐧 𝐧𝐮𝐨𝐯𝐨 𝐢𝐧𝐧𝐞𝐬𝐭𝐨, 𝐚𝐟𝐟𝐢𝐧𝐜𝐡𝐞́ 𝐨𝐠𝐧𝐢 𝐟𝐢𝐠𝐥𝐢𝐨 𝐝𝐢𝐬𝐩𝐞𝐫𝐬𝐨 𝐩𝐨𝐬𝐬𝐚 𝐫𝐢𝐭𝐫𝐨𝐯𝐚𝐫𝐞 𝐥𝐞 𝐩𝐫𝐨𝐩𝐫𝐢𝐞 𝐫𝐚𝐝𝐢𝐜𝐢 𝐧𝐞𝐥𝐥𝐚 𝐭𝐞𝐫𝐫𝐚 𝐩𝐫𝐨𝐦𝐞𝐬𝐬𝐚 𝐝𝐞𝐥𝐥𝐨 𝐒𝐩𝐢𝐫𝐢𝐭𝐨./n/https://chat.whatsapp.com/IIHHbkE4ufXHt3pcQ37LTX`,
        mentions: allJids
    });
